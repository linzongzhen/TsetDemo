package com.springboot.es.demo.controller;
...
public class ESController {
    ...
    public ResponseEntity add(@RequestParam(name = "title") String title,
                              ...
                              @RequestParam(name = "publish_date") @DateTimeFormat(pattern = "yyy-MM-dd HH:mm:ss")
                                      Date publishDate) {
        try {
    ...
    public ResponseEntity update(@RequestParam("id") String id,
                                 ...
                                 @RequestParam(value = "word_count", defaultValue = "0") int wordCount,
                                 @RequestParam(value = "publish_date", required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                                 Date publishDate) {
